...
- **Move playhead to different positions**
- **Drag media to reorder**

**Voiceover:**
"Frame-accurate editing with multi-track support. Drag and drop to rearrange. Zoom for precision. Every track is organized and accessible. This isn't just a basic trimmer - it's a complete video editing suite."

**[Action: Trim a video clip, adjust boundaries]**

**Voiceover:**
"Trim clips with pixel-perfect precision. Adjust start and end points. Layer elements across tracks for sophisticated compositions."
...
**Voiceover:**
"Let's explore the editor panels. First up - media sources."

**[Action: Click Media panel]**

**Voiceover:**
"Upload your own media directly, or tap into our integrated stock libraries."

**[Action: Click Stock Video panel]**
**[Screen: Show Pexels video search with pre-populated results based on brand]**

**Voiceover:**
"Browse millions of free stock videos from Pexels. Notice how it's already searched for relevant content based on your brand. Smart suggestions save you time."

**[Action: Preview a video from pre-searched results, add to timeline]**

**[Action: Click Stock Image panel]**
**[Screen: Show Pexels image library with pre-searched results]**

**Voiceover:**
"Same for stock images - pre-searched with relevant content, curated collections at multiple resolutions."

**[Action: Click Stock Audio panel]**
**[Screen: Show Jamendo audio library]**

**Voiceover:**
"And background music from Jamendo, categorized by mood and genre. Listen before you add."

**[Action: Preview an audio track, add to timeline]**
...
**Voiceover:**
"AI Voice powered by ElevenLabs. Over 20 voices in 28 languages. Preview each voice, filter by gender or language, then generate."

**[Action: Type script text, select voice, preview, generate]**
**[Screen: Show generated voiceover appearing on timeline]**
...
**Voiceover:**
"Turn static images into dynamic video with our Akool-powered AI Video feature. Select an image from your timeline or upload one."

**[Action: Select an image, enter motion prompt like "slow zoom in, pan right"]**
**[Screen: Show quality options: 720p, 1080p, 4K]**

**Voiceover:**
"Add motion prompts, choose your resolution up to 4K, and generate 5-10 second animated clips."

**[Action: Generate and show result added to timeline]**
...
**Voiceover:**
"Let's add text elements."

**[Action: Add a text element to canvas]**
**[Screen: Show right-side properties panel]**

**Voiceover:**
"Choose from over 100 Google Fonts. Adjust sizing from 8 to 200+ pixels. Apply solid colors or gradients."

**[Action: Change font, size, color in properties panel]**

**[Action: Show text alignment, letter spacing, line height controls]**

**Voiceover:**
"Fine-tune alignment, letter spacing, line height. Add outlines with custom widths and colors. Add shadows for depth."
...
**Voiceover:**
"Bring text to life with animations. Typewriter effects for entrances. Background fades. Sound waves."

**[Action: Apply typewriter in animation, show preview]**

**Voiceover:**
"Exit animations like typewriter out. And loop animations - vintage effects, pulse, rotating fonts."

**[Action: Apply pulse loop animation, show preview]**
...
**Voiceover:**
"Smooth scene transitions connect your story."

**[Action: Show transition categories]**

**Voiceover:**
"Fade and cross-fade. Slide in all directions. Wipes - horizontal, vertical, diagonal. Clock wipes for radial effects. Shape wipes with stars, circles, rectangles."

**[Action: Apply a slide transition between two clips on timeline]**
**[Screen: Show transition duration adjustment]**

**Voiceover:**
"Apply between clips and customize duration for the perfect timing."

**[Action: Preview transition]**
...
**Voiceover:**
"Every element in your timeline has professional-grade controls."

**[Action: Demonstrate effects]**

**Voiceover:**
"Apply blur with intensity control for focus effects."

**[Action: Apply blur, adjust intensity slider]**

**Voiceover:**
"Adjust brightness. Flip horizontal or vertical."

**[Action: Show brightness and flip controls]**

**Voiceover:**
"Add outlines and shadows with custom colors, blur radius, and offset."

**[Action: Apply shadow effect]**

**Voiceover:**
"Transform with rotation and scale controls. Adjust opacity for transparency. Control playback speed from half-speed to double-speed."

**[Action: Adjust playback speed slider]**

**Voiceover:**
"And per-track volume control for perfect audio mixing."

**[Action: Adjust volume slider for an audio track]**
...
**Voiceover:**
"A professional, brand-authentic video ad, ready to capture attention and drive results."
...
**Voiceover:**
"Ready to export? Choose your aspect ratio."

**[Action: Show aspect ratio options]**

**Voiceover:**
"Portrait for social stories and reels. Square for Instagram feeds. Landscape for YouTube and traditional platforms."

**[Action: Select portrait (9:16)]**

**Voiceover:**
"Select local rendering for H.264 MP4 files up to 60 frames per second, or use cloud rendering for faster processing."

**[Action: Show render progress]**

**Voiceover:**
"Real-time progress tracking keeps you informed. And with auto-save, your work is always protected - never lose progress."
...
**Voiceover:**
"Brand-authentic video ads, generated in seconds, customized to perfection. The best of both worlds."
...
- **Cursor:** Show cursor for actions, hide during playback
- **Zoom:** Use screen zoom for small UI elements
...
1. **Speed:** One-click generation vs multi-step wizards
2. **Authenticity:** Real brand content vs AI avatars/slideshows
3. **Power:** Full timeline editor vs basic controls
4. **Intelligence:** AI that enhances vs AI that dominates
5. **Flexibility:** Professional tools without complexity

### Visual Hierarchy During Recording
- **Primary focus:** Timeline and canvas (60% of screen time)
- **Secondary focus:** Side panels (30% of screen time)
- **Tertiary focus:** Properties panel (10% of screen time)

### Troubleshooting
- If generation is slow, mention "processing time varies"
- If preview lags, pause and say "previewing at full quality"
- Keep backup clips ready in case live demo has issues
...
Smooth scene transitions connect your story. Fade and cross-fade. Slide in all directions. Wipes - horizontal, vertical, diagonal. Clock wipes for radial effects. Shape wipes with stars, circles, rectangles. Apply between clips and customize duration for the perfect timing.
...
## VIDEO PRODUCTION WORKFLOW RECOMMENDATIONS

### RECOMMENDED APPROACH: Pre-Record Narration + Screen Recording

**Why this works best:**
1. **Consistency** - You can re-record screen actions without redoing voiceover
2. **Efficiency** - Separate audio and video editing reduces mistakes
3. **Quality** - Focus on each element independently for better results
4. **Flexibility** - Easy to adjust timing and pacing in post-production

### STEP-BY-STEP PRODUCTION PROCESS:

#### Phase 1: Audio Production (30-45 minutes)
1. **Generate AI Narration:**
   - Use ElevenLabs or similar service
   - Copy the paragraph script above
   - Choose a professional, clear voice (avoid overly casual or robotic)
   - Export as high-quality MP3 or WAV (320kbps minimum)
...
1. **Record in Segments:**
   - Don't try to record all at once
   - Record each PART as a separate clip
   - Listen to narration with headphones while recording
   - Match your actions to the narration timing
...
3. **Recording Tips:**
   ...
   - Show cursor during actions, can hide in post if needed
   - Move cursor slowly and deliberately
   - Pause for 2-3 seconds on important UI elements

#### Phase 4: Video Editing (2-3 hours)
1. **Assembly:**
   - Import all segments into DaVinci Resolve, Premiere, or Final Cut
   - Import your narration audio track
   - Lay narration on audio track 1
   - Lay background music on audio track 2

2. **Sync & Trim:**
   - Place video segments to match narration timing
   - Cut out mistakes, loading screens, unnecessary pauses
   - Speed up slow sections (1.2x-1.5x) if needed
   - Add quick cuts (0.3s fade) between major sections